...
import com.zongb.sm.opencart.tbass.Ass;
...
public class ProductController {
	...
	public String assInit(Model model) throws Exception {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/ass/save")
	@ResponseBody 
	public Map<String,Object> assSaveProducts(@ModelAttribute("param") OcParameter param) throws Exception {
		...
		System.out.println("=========此产品已存在的最大编号为："+param.getProductSeqStart()+",最大model为："+maxModel);
		AbstractTaoBao taobao = new Ass(param) ;
		//开始时间
		long start = System.currentTimeMillis() ;
		List<Product>  products = taobao.getProductList() ;
